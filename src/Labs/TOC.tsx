  ...
  return (
    <Nav variant="pills" id="wd-toc">
      <Nav.Item> <Nav.Link as={Link} to="/Labs/Lab1" id="wd-a1"
           active={pathname === "/Labs/Lab1"}> Lab 1 </Nav.Link> </Nav.Item>
      ...
      <Nav.Item> <Nav.Link href="https://github.com/irisjc13" target="_blank"> My GitHub </Nav.Link> </Nav.Item>
      <Nav.Item> <Nav.Link href="https://kambaz-node-server-app-1-8mke.onrender.com" target="_blank"> Render Link </Nav.Link> </Nav.Item>
